...
class ValidatorStringBloc {
  ...
  static Validator<String> minLength(TextFieldBloc textFieldBloc, int length) =>
      (String textField) =>
          (textField.length < length) ? "El campo debe tener minimo $length caracteres" : null;
  ...
  static Validator<String> confirmPassword(TextFieldBloc password) => (String passwordConfirm) =>
